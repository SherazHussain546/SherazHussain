  ...
  return (
    <div className={cn(
      ...
      <style jsx global>{`
        ...
        .thick-rule {
          border: none;
          border-top: 3px double hsl(var(--foreground));
          margin: 56px 0 48px;
        }
      `}</style>
        ...
        <div className="max-w-[1100px] mx-auto px-6 py-12 md:py-20">
          ...
          <div className="grid gap-16 lg:grid-cols-12 items-start mb-32">
            ...
            <div className="lg:col-span-7 space-y-12">
              <section className="drop-cap font-sans font-light text-lg md:text-xl leading-relaxed text-foreground/90">
                <p>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-serif text-2xl font-bold">Technical Milestones</h2>
                </div>
                <div className="grid gap-6 sm:grid-cols-2">
                  {projectGoals.map((goal, idx) => (
                    <Card key={idx} className="bg-muted/5 border-border/50 hover:bg-muted/10 transition-colors">
                      <CardHeader className="p-6">
                        <Badge variant="outline" className="w-fit mb-2 text-[8px] font-mono tracking-widest">PHASE 0{idx + 1}</Badge>
              ...
              {/* Web3 Module */}
              <div className="bg-[#071739] text-white rounded-[2rem] p-10 relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <h3 className="text-3xl font-serif font-bold">Decentralized Support</h3>
                  ...
                  <div className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 p-4 group">
            ...
            <div className="lg:col-span-5 space-y-8">
              <Card className="shadow-2xl border-primary/20 bg-white sticky top-24">
                <CardHeader className="border-b pb-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <CardTitle className="text-xl font-bold">Stripe Secure</CardTitle>
                        <CardDescription className="text-xs">Direct encrypted processing.</CardDescription>
                      </div>
                    </div>
                    <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-600 font-bold uppercase tracking-widest text-[8px] border-none">
                      Active
                    </Badge>
                  </div>
                </CardHeader>
                <CardContent className="pt-8 space-y-8">
                  ...
                  <div className="pt-6 border-t border-dashed">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-4">Enterprise Tiers (Future)</p>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 rounded-lg border border-border/50 opacity-50 grayscale cursor-not-allowed">
                        <div className="flex items-center gap-3">
                          <Zap className="h-4 w-4 text-primary" />
                          <span className="text-xs font-bold">Strategic Partner</span>
                        </div>
                        <span className="text-[10px] font-mono">Coming Soon</span>
                      </div>
                      <div className="flex items-center justify-between p-3 rounded-lg border border-border/50 opacity-50 grayscale cursor-not-allowed">
                        <div className="flex items-center gap-3">
                          <Cpu className="h-4 w-4 text-primary" />
                          <span className="text-xs font-bold">Infrastructure Patron</span>
                        </div>
                        <span className="text-[10px] font-mono">Coming Soon</span>
                      </div>
                    </div>
              ...
              <div className="grid gap-4">
                {supportMethods.map((method, idx) => (
                  <Link key={idx} href={method.link} target="_blank">
                    <Card className="group border-border/40 hover:border-primary/30 transition-all hover:shadow-lg bg-card/50 backdrop-blur-sm">
                      <CardHeader className="flex flex-row items-center gap-4 p-4">
                        <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg ${method.color}`}>
                          <method.icon className="h-5 w-5" />
                        </div>
                        <div className="flex-1">
                          <p className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground">{method.title}</p>
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-bold">{method.actionLabel}</span>
