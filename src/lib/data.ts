...
export const allCertificates: CertificateType[] = [
  {
    ...
    icon: Award,
    skills: ['C++', 'Object-Oriented Programming', 'Code Optimization'],
    points: [
      'Refined complex data structures to optimize performance in a simulated EA environment.',
      'Developed low-level header files and class diagrams for high-performance objects.',
    ],
  },
  {
